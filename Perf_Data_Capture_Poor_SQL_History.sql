...
/****** Object:  Job [Perf_Data_Capture_Poor_SQL_History]    Script Date: 03/09/2019 15:02:37 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 03/09/2019 15:02:37 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Perf_Data_Capture_Poor_SQL_History', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Capture Poor SQL History]    Script Date: 03/09/2019 15:02:37 ******/
