...
/****** Object:  Job [Perf_Data_Capture Poor SQL History]    Script Date: 03/09/2019 14:46:53 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 03/09/2019 14:46:53 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Perf_Data_Capture Poor SQL History', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Capture Poor SQL History]    Script Date: 03/09/2019 14:46:53 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Capture Poor SQL History', 
		@step_id=1, 
		...
		@command=N'INSERT INTO [DBAPerfData].[dbo].[Poor_Query_Cache]
SELECT TOP 20
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily 13:00', 
		...
		@active_start_date=20190813, 
		@active_end_date=99991231, 
		@active_start_time=130000, 
		@active_end_time=235959, 
		@schedule_uid=N'a4df103c-ffe7-4b45-a4f9-089963272f3d'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
